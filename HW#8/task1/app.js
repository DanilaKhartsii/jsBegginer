...
function handleClick(clickedButtonEvent) {
    ...
    let textBtn = card.button.innerText;
...
function showMoreText(card) {
    ...
    let anotherText = 'Lorem ipsum dolor sit amet.';
    card.productName.insertAdjacentHTML('afterend', `<div class = 'desc'>${anotherText}</div>`);
