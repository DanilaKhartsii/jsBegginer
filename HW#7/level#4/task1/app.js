...
let productsCollection = document.querySelector('.products');
...
function showCategory(category) {
    let objectCollection = products[category];
    objectCollection.forEach(getProductMarkup);
}
...
function getProductMarkup(product) {
    productsCollection.insertAdjacentHTML('afterbegin', `<div class="product">
